"""Remove dead agent orchestration duplicates from worker_tasks."""
...
REMOVE = {
    "_run_agent_full_pipeline_tail",
    "_run_agent_run_impl_legacy_unused",
}
...
def main() -> None:
    ...
    print(f"removed {len(remove_ranges)} functions from {WT}")
