...
export function StudioSettingsPage({ p }) {
  ...
  const showDesktopTab = typeof window !== "undefined" && window.directorDesktop?.isDesktop;
...
<section className="panel settings-page">
          ...
          <div className="settings-layout">
            <nav className="settings-nav" aria-label="Settings sections">
              ...
              {showDesktopTab ? (
                <button
                  type="button"
                  className={settingsTab === "desktop" ? "is-active" : ""}
          ...
          <Suspense fallback={<StudioPageLoading label="Loading settings section…" />}>
            ...
            {settingsTab === "desktop" ? <LazySettingsDesktopPanel /> : null}
          </Suspense>
            </div>
          </div>
        </section>
